  ...
  const reviewListItem: TransactionListItem | null =
    transaction.status === "needs_review" && transaction.entries.length === 0
      ? {
          ...
          sourceAccount: hint?.sourceAccount || null,
          targetAccount: hint?.targetAccount || null,
          originalAmount: hint?.amount != null ? Math.abs(hint.amount) : null,
          currency: hint?.currency ?? null,
          exchangeRate: hint?.exchangeRate ?? null,
